...
resource "google_compute_instance" "vm-instance" {
  ...
  shielded_instance_config {
    enable_secure_boot          = var.enable_secure_boot          # Secure Boot ON
    enable_vtpm                 = var.enable_vtpm                 # vTPM ON
    enable_integrity_monitoring = var.enable_integrity_monitoring # Integrity Monitoring ON
  }
