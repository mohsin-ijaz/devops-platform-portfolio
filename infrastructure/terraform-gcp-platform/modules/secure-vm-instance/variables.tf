...
variable "enable_secure_boot" {
  type        = bool
  default     = true
  description = "Set enable_secure_boot to true or false"
}

variable "enable_vtpm" {
  type        = bool
  default     = true
  description = "Set enable_vtpm to true or false"
}

variable "enable_integrity_monitoring" {
  type        = bool
  default     = true
  description = "Set enable_integrity_monitoring to true or false"
}